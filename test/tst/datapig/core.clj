...
(deftest t-01
  (try
    ...
    (newline)
    (create-entity {:name "alan"    :age 11} )
    (create-entity {:name "bob"     :age 22} )
    (create-entity {:name "carrie"  :age 33} )
    (create-entity {:name "david"   :age 44} )
    (create-entity {:name "earl"    :age 55} )
    (newline)
    (catch Exception ex
      (do (spyx ex)
